...
export default function Navbar() {
  ...
  return (
    <nav className="relative z-50 bg-white/90 backdrop-blur-md shadow-sm px-6 py-4 flex justify-between items-center">
      ...
      {/* Mobile Menu */}
      {open && (
        <div className="absolute top-full left-0 w-full bg-white shadow-md flex flex-col p-4 md:hidden gap-3">
